...
function menu(){
    ...
    while(finalizarMenu == false){
        ...
        let opcion = prompt(`Ingrese la opción que desea:
                            ...
                            6 - 
                            7 - 
                            8 - Utilizar cupon de descuento. Ver todos los libros con un 25% menos
                            9 - Eliminar libro
                            0 - Salir del menú`)
        switch(opcion){
            case "1":
            ...
            break
            case "4":
                let opcionOrdenar = prompt(`Ingrese elcriterio por el que desea ordenar:
                1 - Menor a mayor por precio
                2 - Mayor a menor
                3 - Mostrar biblio
                4 - Ordenar menor a mayor`)
