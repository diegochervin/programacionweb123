...
const modificar =" UPDATE `baterias` SET `precio` = '15000' WHERE `baterias`.`id` = 7;"
const borrar = "DELETE FROM baterias WHERE id = 8"
conexion.query(modificar, function(err, resultado){
